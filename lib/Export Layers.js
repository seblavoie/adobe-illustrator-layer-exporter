...
LayerExporter = (function() {
  function LayerExporter() {
    ...
    this.outputFolder = Folder.selectDialog('Choose output folder.');
    this.exportLayers(app.activeDocument);
    alert("All layers have been exported to " + this.outputFolder + "/!");
  }
  ...
  LayerExporter.prototype.exportLayers = function(root) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      app.copy();
      file = new File(this.outputFolder + "/" + layer.name + ".ai");
